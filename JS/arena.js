let channelSlug = 'butterflies-e_zebeltj7k' // The “slug” is just the end of the URL.
let myUsername = 'riya-shrestha-ohjw70so-wu' // For linking to your profile.
...
let placeChannelInfo = (channelData) => {
	...
	channelLastUpdated.innerHTML = new Date(channelData.updated_at).toLocaleDateString()
